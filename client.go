...
// interacting with the chamelaion API. You should not instantiate this client
...
// CHAMELAION_BEARER_TOKEN, CHAMELAION_BASE_URL). This should be used to initialize
// new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithHTTPClient(defaultHTTPClient()), option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("CHAMELAION_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("CHAMELAION_BEARER_TOKEN"); ok {
		defaults = append(defaults, option.WithBearerToken(o))
	}
	if o, ok := os.LookupEnv("CHAMELAION_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("CHAMELAION_CUSTOM_HEADERS"); ok {
...
// environment (CHAMELAION_API_KEY, CHAMELAION_BEARER_TOKEN, CHAMELAION_BASE_URL).
